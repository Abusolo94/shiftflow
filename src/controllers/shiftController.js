...
//     // Store account can ONLY create
//     // shifts for its own store.
//     if (
//       req.user.accountType === "store"
//     ) {
//       if (!req.user.storeId) {
